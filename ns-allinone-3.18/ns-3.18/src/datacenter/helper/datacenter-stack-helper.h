...
#include "datacenter-trace-helper.h"
 ...
 *
 * This helper enables pcap and ascii tracing of events in the datacenter stack
 ...
 */
class DatacenterStackHelper : public PcapHelperForIpv4, public PcapHelperForIpv6, 
                            public AsciiTraceHelperForIpv4, public AsciiTraceHelperForIpv6
{
public:
  /**
   * Create a new DatacenterStackHelper which uses a mix of static routing
   ...
   */
  DatacenterStackHelper(void);

  /**
   * Destroy the DatacenterStackHelper
   */
  virtual ~DatacenterStackHelper(void);
  DatacenterStackHelper (const DatacenterStackHelper &);
  ...
  * \param c NodeContainer of the set of nodes for which the datacenter models

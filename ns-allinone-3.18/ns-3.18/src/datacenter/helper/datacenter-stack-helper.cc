...
/**
 * \ingroup datacenter
 * \defgroup datacenterStackModel Datacenter Stack Model
 *
 * \section datacenterStackTracingModel Tracing in the Datacenter Stack
 *
 * The datacenter stack provides a number of trace sources in its various
 ...
 *
 * \subsection datacenterStackArpTracingModel Tracing in ARP
 *
 ...
 *
 * \subsection datacenterStackIpv4TracingModel Tracing in IPv4
 *
 ...
 *   event is fired.
 *
 * \subsection datacenterStackNs3TCPTracingModel Tracing in ns-3 TCP
 *
 ...
 * window is changed.
 *
 * \subsection datacenterStackNscTCPTracingModel Tracing in NSC TCP
 *
 ...
 *
 * \subsection datacenterStackNs3UdpTracingModel Tracing in ns-3 UDP
 *
...
#include "datacenter-stack-helper.h"
...
NS_LOG_COMPONENT_DEFINE ("DatacenterStackHelper");
...
DatacenterStackHelper::DatacenterStackHelper ()
  : m_routing (0),
    m_routingv6 (0),
    m_ipv4Enabled (true),
    m_ipv6Enabled (true),
...
void
DatacenterStackHelper::Initialize ()
{
...
DatacenterStackHelper::DatacenterStackHelper (const DatacenterStackHelper &o)
{
...
DatacenterStackHelper &
DatacenterStackHelper::operator = (const DatacenterStackHelper &o)
{
  if (this == &o)
    {
      return *this;
...
void
DatacenterStackHelper::Reset (void)
{
  delete m_routing;
  m_routing = 0;
  delete m_routingv6;
...
void 
DatacenterStackHelper::SetRoutingHelper (const Ipv4RoutingHelper &routing)
{
  delete m_routing;
...
void
DatacenterStackHelper::SetRoutingHelper (const Ipv6RoutingHelper &routing)
{
  delete m_routingv6;
...
void
DatacenterStackHelper::SetIpv4StackInstall (bool enable)
{
  m_ipv4Enabled = enable;
}

void DatacenterStackHelper::SetIpv6StackInstall (bool enable)
{
  m_ipv6Enabled = enable;
}

void DatacenterStackHelper::SetIpv4ArpJitter (bool enable)
{
  m_ipv4ArpJitterEnabled = enable;
}

void DatacenterStackHelper::SetIpv6NsRsJitter (bool enable)
{
  m_ipv6NsRsJitterEnabled = enable;
}

int64_t
DatacenterStackHelper::AssignStreams (NodeContainer c, int64_t stream)
{
...
void
DatacenterStackHelper::SetTcp (const std::string tid)
{
  m_tcpFactory.SetTypeId (tid);
}

void 
DatacenterStackHelper::SetTcp (std::string tid, std::string n0, const AttributeValue &v0)
{
  m_tcpFactory.SetTypeId (tid);
...
void 
DatacenterStackHelper::Install (NodeContainer c) const
{
  for (NodeContainer::Iterator i = c.Begin (); i != c.End (); ++i)
    {
      Install (*i);
...
void 
DatacenterStackHelper::InstallAll (void) const
{
  Install (NodeContainer::GetGlobal ());
}

void
DatacenterStackHelper::CreateAndAggregateObjectFromTypeId (Ptr<Node> node, const std::string typeId)
{
...
void
DatacenterStackHelper::Install (Ptr<Node> node) const
{
  if (m_ipv4Enabled)
    {
      if (node->GetObject<Ipv4> () != 0)
        {
          NS_FATAL_ERROR ("DatacenterStackHelper::Install (): Aggregating " 
                          "an DatacenterStack to a node with an existing Ipv4 object");
          return;
        }
  ...
  if (m_ipv6Enabled)
    {
      ...
      if (node->GetObject<Ipv6> () != 0)
        {
          NS_FATAL_ERROR ("DatacenterStackHelper::Install (): Aggregating " 
                          "an DatacenterStack to a node with an existing Ipv6 object");
          return;
        }
...
void
DatacenterStackHelper::Install (std::string nodeName) const
{
...
bool
DatacenterStackHelper::PcapHooked (Ptr<Ipv4> ipv4)
{
...
void 
DatacenterStackHelper::EnablePcapIpv4Internal (std::string prefix, Ptr<Ipv4> ipv4, uint32_t interface, bool explicitFilename)
{
  ...
  if (!PcapHooked (ipv4))
    {
      ...
      NS_ASSERT_MSG (ipv4L3Protocol, "DatacenterStackHelper::EnablePcapIpv4Internal(): "
      ...
      NS_ASSERT_MSG (result == true, "DatacenterStackHelper::EnablePcapIpv4Internal():  "
...
bool
DatacenterStackHelper::PcapHooked (Ptr<Ipv6> ipv6)
{
...
void 
DatacenterStackHelper::EnablePcapIpv6Internal (std::string prefix, Ptr<Ipv6> ipv6, uint32_t interface, bool explicitFilename)
{
  ...
  if (!PcapHooked (ipv6))
    {
      ...
      NS_ASSERT_MSG (ipv6L3Protocol, "DatacenterStackHelper::EnablePcapIpv6Internal(): "
      ...
      NS_ASSERT_MSG (result == true, "DatacenterStackHelper::EnablePcapIpv6Internal():  "
...
bool
DatacenterStackHelper::AsciiHooked (Ptr<Ipv4> ipv4)
{
...
void 
DatacenterStackHelper::EnableAsciiIpv4Internal (
  Ptr<OutputStreamWrapper> stream, 
  std::string prefix, 
  Ptr<Ipv4> ipv4, 
  uint32_t interface,
      ...
      if (!AsciiHooked (ipv4))
        {
          ...
          NS_ASSERT_MSG (result == true, "DatacenterStackHelper::EnableAsciiIpv4Internal():  "
...
bool
DatacenterStackHelper::AsciiHooked (Ptr<Ipv6> ipv6)
{
...
void 
DatacenterStackHelper::EnableAsciiIpv6Internal (
  Ptr<OutputStreamWrapper> stream, 
  std::string prefix, 
  Ptr<Ipv6> ipv6, 
  uint32_t interface,
      ...
      if (!AsciiHooked (ipv6))
        {
          ...
          NS_ASSERT_MSG (result == true, "DatacenterStackHelper::EnableAsciiIpv6Internal():  "
